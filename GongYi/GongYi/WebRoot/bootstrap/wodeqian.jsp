...
<html>
  ...
  <style>
	*{margin:0;padding:0}
	...
	#daohang2{width:80%;;background:#FA96BB;margin-top:10px;margin-bottom:50px;margin-left:135px;}
	.main{width:64%;height:650px;border:1px solid #C0C0C0;margin:0 auto;}
	...
	.right_button1{width:100px;height:30px;background-color:#C0C0C0; margin-top:80px;margin-left:30px;float:left;}
	 ...
	 <div class="main">
	 	<div class="left">
	 		...
	 		<div class="left_under">
	 			<div class="under_xiangmu">申请的金额:</div>
	 		</div>
	 	</div>
	 	...
	 	<div class="right">
	 		...
	 		<div>
	 			<table class="table table-bordered">
	 				...
	 				<td>${z.expend_name }</td>
	 				<td>${z.enroll_sname }</td>
	 				<td>${z.expend_money }</td>
	 				<td>${z.expend_time }</td>
	 				<td>${z.expend_perspon }</td>
	 				<td>${z.expend_status }</td>
	 				</tr>
	 				</c:forEach>
	 				</tbody>
	 			</table>
