...
/* .under_xiangmu{float:left;}
	.under_money{float:right;} */
.left_under span {
	color: red;
}
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li class="color"><a href="l_select.action"><span
								class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;公益项目</a></li>
						<li class="color"><a href="#"><span
								class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;信息公开</a></li>
						...
						<li class="dropdown"><a href="faqixiangmu.jsp"
							class="dropdown-toggle" id="color"><span
								class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;<span>发起项目</span>
						</a>
						</li>
					</ul>
				</div>
		...
		<div class="main">
			<div class="left">
				...
				<div class="left_under">
					<div class="under_xiangmu">
						捐助项目<span>${ls}</span>个
					</div>
					<div class="under_money">
						共<span>${money}</span>元
					</div>
				</div>
			</div>
			...
			<div class="right">
				...
				<%-- <div style="float:right;height:50px;margin-right:100px;">${list.pageStr }<br>&nbsp;&nbsp; 共${list.allPage }&nbsp;页 </div> --%>
			</div>
		</div>
