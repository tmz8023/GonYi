...
public class QQ {
	private int ex_id;        //±‡∫≈
	private String ex_name;          //…Í«ÎœÓƒø√˚≥∆
	private Date ex_time;                //…Í«Î ±º‰
	private String ex_company;             //…Í«Îµ•Œª
	private String ex_reason;     //…Í«Î‘≠“Ú
	private int ex_money;   //…Í«ÎΩ∂Ó
	private String ex_person;   //…Í«Î»À
	private String ex_status;  //…Í«Î◊¥Ã¨
	public int getEx_id() {
		return ex_id;
	}
	...
	public String getEx_person() {
		return ex_person;
	}
	public void setEx_person(String ex_person) {
