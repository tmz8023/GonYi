		...
		<div class="m-right">
			...
			<div class="main">
				...
				<div Style="text-align:right">
					<a href="book_chaxun.action"><button type="button"
							...
							<tr>
								...
								<%-- <td>					   	
				                	<div class="btn-toolbar">
					                      <button class="btn btn-default btn-xs text-danger round" ><a href="book_delete.action?a=${b.expend_askid}">删除</a></button>
				                  	</div>         
								</td> --%>
							</tr>
						</c:forEach>
			...
			<div style="text-align:center;">
							<a href="book_money.action"><button type="button"
									class="btn btn-info">支出总金额：${money} &nbsp;元</button>
							</a>
							<a href="book_mon.action"><button type="button"
									class="btn btn-info">剩余总金额：${hao} &nbsp;元</button>
							</a>
						</div>
			<div class="pagelist">
