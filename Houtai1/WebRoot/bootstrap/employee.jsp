	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="emp_addEmployee.action" method="post" >
					...
					性别：<select class="form-control" name="sf_gender">
							<option>男</option>
							<option>女</option>
						</select>
					身份证号：<input type="text" class="form-control" name="sf_cardId">
					员工角色：<select class="form-control" name="sf_posname">
							<option>BOSS</option>
							<option>会计</option>
							<option>普通员工</option>
							<option>执行董事</option>
		  ...
		  <div class="modal fade" id="exampleModal11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <form action="emp_UpdateEmployee.action" method="post">
			          	员工角色：<select class="form-control" name="sf_posname">
			          				<option>BOSS</option>
									<option>会计</option>
									<option>普通员工</option>
			          	...
			          	员工状态：<select  class="form-control" name="sf_status">
				          	  		<option>1</option>
				          	  		<option>2</option>	
			          	    	</select>		
			           	ID:<input class="form-control" name="sf_id"/>
