		...
		<div class="left_menu">
			<ul id="nav_dot">
				...
				<li>
					...
					<div class="list-item none">
						<a href="userInfo.jsp">用户信息审核</a><a href="ww_Reviewprojectservlet.action">公益项目审核</a> <a href='book_shen.action'>资金申请审核</a>
					</div></li>
				<li>
					<h4 class="M4">
						<span></span>理事管理
				...
				<li>
					...
					<div class="list-item none">
						<!-- <a href="news.jsp">新闻发布</a> --><a href='p_select1.action'>项目管理</a>
					</div></li>
				<li>
					<h4 class="M3">
						<span></span>财务管理
		...
		<div class="m-right">
			...
			<div class="main">
				<div id="main" style="text-align:center;">
					<div style="color:yellow;padding-top:100px;"><h1>欢迎使用第七小组后台管理系统</h1></div>
