...
<body>
	...
	<div id="content">
			...
			<div class="main">
				...
				<div class="col-lg-3">
						    <div class="input-group">
						    	<form action="Rol_.action" method="post">
					...
					<div Style="text-align:right">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleMod22" data-whatever="@mdo">角色授权</button>	
						<button type="button" class="btn btn-success"><a href="Rol_showRole.action">查询所有</a></button>
		...
		<!--     用户增加的 模态框                     -->
		<div class="modal fade" id="exampleMod22" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
